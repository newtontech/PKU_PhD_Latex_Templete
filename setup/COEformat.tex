...
\def\etitle#1{\def\@etitle{#1}}\def\@etitle{}
\def\firstclassmajor#1{\def\@firstclassmajor{#1}}\def\@firstclassmajor{}
\def\secondclassmajor#1{\def\@secondclassmajor{#1}}\def\@secondclassmajor{}
\def\thesisindex#1{\def\@thesisindex{#1}}\def\@thesisindex{}
\def\makecover{
    \begin{titlepage}
    %中文封面%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \newpage
...
%    \end{tabular} } \\
    \vspace*{2.2cm}
%    {\typexingming \hspace*{-5.8cm}
%    \begin{tabular}{lp{10cm}}
%    中文题目： \hspace*{1mm}& {\typename \@ctitle}\\
%    英文题目： & {\typename \@etitle}\\ 
%    & \\
%    一级学科： & {\typename \@firstclassmajor}\\ 
%    二级学科： & {\typename \@secondclassmajor}\\ 
%    论文编号： & {\typename \@thesisindex}\\ \cline{2-2}
%    　 　 & {\hspace*{5.8cm}}　
%    \end{tabular} } \\
%}
	\begin{flushleft}
	...
	一级学科：{\typename \@firstclassmajor}\\ 
	二级学科：{\typename \@secondclassmajor}\\ 
	论文编号：{\typename \@thesisindex}\\
	}
	\end{flushleft}}
\vspace*{1.0cm}
	\typedate √ 学术学位      \hspace{1.0cm}  □ 专业学位\\
    \vspace*{2.0cm}
    \hspace{8.0cm}\typedate \@cdate
...
%    \vspace*{2cm} 
%    By \\
%    \textbf{\@eauthor , Doctor Candidate} \\
%    \textbf{(\@esubject)} \\}
%    \vspace*{0.8cm}
%    {\typeenglishlarge
